...
Object.defineProperty(RoomObject.prototype, 'isNearBase', {
 get: function() 
 {
     return  this.pos.findInRange(FIND_MY_STRUCTURES, 2, {filter: s=> (s.structureType == STRUCTURE_EXTENSION || 
        s.structureType == STRUCTURE_SPAWN || s.structureType == STRUCTURE_STORAGE) }).length > 0;
 },
